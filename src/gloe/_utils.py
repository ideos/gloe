...
from typing import TypeVar, get_origin, TypeAlias, TypedDict, Generic, Union, _GenericAlias  # type: ignore
...
def _match_types(generic, specific, ignore_mismatches=True):
    ...
    if (specific_origin is None or generic_origin is None) or \
            not issubclass(specific_origin, generic_origin):
